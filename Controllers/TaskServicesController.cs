    ...
    public class TaskServicesController : ControllerBase
    {
        ...
        public async Task<ActionResult<TaskService>> PostTaskService(TaskService taskService)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                string message = "taskId:"+taskService.taskId+ "," +
                                    "taskDescription:" +taskService.taskDescription+","+
                                        "taskPriority:"+taskService.taskPriority+ ","+
                                            "taskStatus:" +taskService.taskStatus+ ","+
                                                "customerId:" +taskService.customerId;
